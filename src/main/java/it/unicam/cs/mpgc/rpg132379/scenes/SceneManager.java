...
import it.unicam.cs.mpgc.rpg132379.persistence.PlayerSaveManager;
...
public class SceneManager {
    ...
    // semi-static it.unicam.cs.mpgc.rpg132379.scenes (created only when the players press "Play" in the main menu)
    private SceneFactory mainMenuScene;
    private SceneFactory shopScene;

    // dynamic it.unicam.cs.mpgc.rpg132379.scenes (re-created every time they are needed)
